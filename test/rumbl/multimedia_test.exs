defmodule Rumbl.MultimediaTest do
  ...
  describe "categories" do
    test "list_alphabetical_categories/0" do
      for name <- ~w(Drama Romance Comedy) do
      ...
      assert alpha_names == ~w(Comedy Drama Romance)
    end
  end
  ...
  describe "videos" do
    ...
    test "update_video/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} = Multimedia.update_video(%Video{id: id}, @invalid_attrs)
